...
//===----------------------------------------------------------------------===//
// PinchToLLVM RewritePatterns: Constant operations
//===----------------------------------------------------------------------===//
...
struct ConstantOpLowering : public OpRewritePattern<pinch::ConstantOp> {
  ...
  LogicalResult matchAndRewrite(pinch::ConstantOp op,
    ...
    auto valueAttr =
        rewriter.getIntegerAttr(rewriter.getIndexType(), constantValue);
...
struct BinaryOpLowering : public ConversionPattern {
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    // loop.
    auto loadedLhs =
      rewriter.create<LoadOp>(loc, binaryAdaptor.lhs());
    auto loadedRhs =
      rewriter.create<LoadOp>(loc, binaryAdaptor.rhs());
...
namespace {
struct PinchToLLVMLoweringPass : public ModulePass<PinchToLLVMLoweringPass> {
  void runOnModule() final;
};
} // end anonymous namespace

void PinchToLLVMLoweringPass::runOnModule() {
  ...
  patterns.insert<AddOpLowering>(&getContext());
  patterns.insert<MulOpLowering>(&getContext());
