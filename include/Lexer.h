//===- Lexer.h - Lexer for the Pinch language -------------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements a simple Lexer for the Pinch language.
//
//===----------------------------------------------------------------------===//

#ifndef MLIR_TUTORIAL_PINCH_LEXER_H_
#define MLIR_TUTORIAL_PINCH_LEXER_H_
...
#endif // MLIR_TUTORIAL_PINCH_LEXER_H_
